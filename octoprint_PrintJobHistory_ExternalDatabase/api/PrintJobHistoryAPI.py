...
from octoprint_PrintJobHistory_ExternalDatabase import PrintJobModel, TemperatureModel, FilamentModel, CostModel
...
from octoprint_PrintJobHistory_ExternalDatabase.common.SettingsKeys import SettingsKeys
